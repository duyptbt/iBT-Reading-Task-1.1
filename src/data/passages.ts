    ...
    wordTasks: [
      {
        ...
        prefix: "th",
        missing: "ey",
        hint: "Pronoun referring back to 'Glaciers'"
      },
      {
        id: 1,
        fullWord: "masses",
        prefix: "mas",
        missing: "ses",
        hint: "Large bodies of matter (noun, plural); here referring to the glacial ice sheets"
      },
      {
        id: 2,
        fullWord: "critical",
        prefix: "crit",
        missing: "ical",
        hint: "Extremely important or crucial (adjective)"
      },
      {
        id: 3,
        fullWord: "in",
        prefix: "i",
        missing: "n",
        hint: "Preposition used to express location, situation, or state"
      },
      {
        id: 4,
        fullWord: "the",
        prefix: "t",
        missing: "he",
        hint: "Definite article specifying unique celestial bodies (Earth's)"
      },
      {
        id: 5,
        fullWord: "surface",
        prefix: "sur",
        missing: "face",
        hint: "The outermost layer of a physical body (noun)"
      },
      {
        id: 6,
        fullWord: "immense",
        prefix: "imm",
        missing: "ense",
        hint: "Vast, huge, or immeasurably large (adjective)"
      },
      {
        id: 7,
        fullWord: "and",
        prefix: "a",
        missing: "nd",
        hint: "Conjunction used to coordinate words, phrases, or clauses"
      },
      {
        id: 8,
        fullWord: "of",
        prefix: "o",
        missing: "f",
        hint: "Preposition expressing relation between movement and glaciers"
      },
      {
        id: 9,
        fullWord: "grind",
        prefix: "gr",
        missing: "ind",
        hint: "Verb meaning to reduce to small particles by friction or crush under heavy pressure"
      }
    ],
    explanation: "Bài đọc TOEFL iBT này minh họa khả năng biến đổi địa chất mạnh mẽ của sông băng. Bằng cách hoàn thành các từ nối liên kết ('they', 'in', 'the', 'and', 'of') và các từ học thuật quan trọng ('masses', 'critical', 'surface', 'immense', 'grind'), bạn sẽ nắm vững mạch liên kết văn bản và vốn từ vựng thường gặp trong các chủ đề Khoa học Trái đất của kỳ thi TOEFL."
  },
  {
    id: "photosynthesis",
